...
type DayjsFn = typeof dayjsImport &
  ((
    date?: string | number | Date | dayjsImport.Dayjs | null,
  ) => dayjsImport.Dayjs);

const dayjs: DayjsFn = (
  typeof dayjsImport === "function"
    ? dayjsImport
    : ((dayjsImport as unknown as { default: DayjsFn }).default ?? dayjsImport)
) as DayjsFn;
